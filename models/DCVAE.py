...
class Encoder(nn.Module):
    def __init__(self, nc, nz, ndf, image_size, cuda):
    ...
    def forward(self, image):
        e1 = self.enc_le1(self.enc_bn1(self.enc_cv1(image)))
        e2 = self.enc_le2(self.enc_bn2(self.enc_cv2(e1)))
        e3 = self.enc_le3(self.enc_bn3(self.enc_cv3(e2)))
...
class Decoder(nn.Module):
    def __init__(self, nz, nc, ngf, image_size):
    ...
    def forward(self, z):
        ...
        d2 = self.dec_lrelu2(self.dec_bn1(self.dec_ct1(d1)))
        d3 = self.dec_lrelu3(self.dec_bn2(self.dec_ct2(d2)))
        d4 = self.dec_ct3(d3)
        d5 = self.sigmoid(d4)
        return d5